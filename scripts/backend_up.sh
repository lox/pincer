...
DEMO_ACTIONS="${PINCER_DEMO_ACTIONS:-0}"
...
tmux new-session -d -s "${SESSION}" \
  "cd '${ROOT_DIR}' && PINCER_HTTP_ADDR='${HTTP_ADDR}' PINCER_DB_PATH='${DB_PATH}' PINCER_TOKEN_HMAC_KEY='${TOKEN_HMAC_KEY}' PINCER_DEMO_ACTIONS='${DEMO_ACTIONS}' mise run run"
